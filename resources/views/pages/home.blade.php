...
<main>
    ...
    <section class="hero__area hero__area--2 position-relative custom-padding">
        <span class="shape shape__1 position-absolute"><img src="{{('frontend/images/shape/hero-shape-2-1.png')}}" alt=""></span>
        <span class="shape shape__2 position-absolute"><img src="{{('frontend/images/shape/hero-shape-2-2.png')}}" alt=""></span>
            ...
            <div class="row mm-reverse">
                ...
                <div class="col-xl-6 col-lg-5">
                    <div class="hero__thumb hero__thumb--2 position-relative">
                        <img src="{{('frontend/images/hero/hero-img-2-1.png')}}" alt="img">
    ...
    <section class="about__area about__area--2 grey-bg position-relative pt-120 pb-130">
        <span class="shape shape__1 position-absolute"><img src="{{('frontend/images/shape/about-shape-2-1.png')}}" alt=""></span>
        <span class="shape shape__2 position-absolute"><img src="{{('frontend/images/shape/about-shape-2-2.png')}}" alt=""></span>
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-7">
                    <div class="about__left about__left--2 position-relative">
                        <img class="big" src="{{('frontend/images/about/about-img-2-1.png')}}" alt="img">
                        <img class="small position-absolute" src="{{('frontend/images/about/about-img-2-2.png')}}" alt="img">
                    </div>
                </div>
    ...
    <section class="popular-menu__area grey-bg position-relative pb-120">
        <span class="shape shape__1 position-absolute"><img src="{{('frontend/images/shape/menu-shape-1.png')}}" alt=""></span>
        <span class="shape shape__2 position-absolute"><img src="{{('frontend/images/shape/menu-shape-2.png')}}" alt=""></span>
        <span class="shape shape__3 position-absolute"><img src="{{('frontend/images/shape/menu-shape-3.png')}}" alt=""></span>
        <span class="shape shape__4 position-absolute"><img src="{{('frontend/images/shape/menu-shape-4.png')}}" alt=""></span>
        <div class="container">
            <div class="row">
            ...
            <div id="popular-menu-grid" class="row popular-menu__grid mt-none-30">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 grid-item cat1 cat5 mt-30">
                    <div class="popular-menu__item">
                        <div class="popular-menu__thumb">
                            <img src="{{('frontend/images/menu/menu-1.jpeg')}}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 grid-item cat2 cat5 cat4 mt-30">
                    <div class="popular-menu__item">
                        <div class="popular-menu__thumb">
                            <img src="{{('frontend/images/menu/menu-2.jpeg')}}" alt="">
                        </div>
                        <div class="popular-menu__content text-center">
                            <h2 class="title">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 grid-item cat1 cat2 cat5 mt-30">
                    <div class="popular-menu__item">
                        <div class="popular-menu__thumb">
                            <img src="{{('frontend/images/menu/menu-3.jpeg')}}" alt="">
                        </div>
                        <div class="popular-menu__content text-center">
                            <h2 class="title">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 grid-item cat3 cat4 cat5 mt-30">
                    <div class="popular-menu__item">
                        <div class="popular-menu__thumb">
                            <img src="{{('frontend/images/menu/menu-4.jpeg')}}" alt="">
                        </div>
                        <div class="popular-menu__content text-center">
                            <h2 class="title">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 grid-item cat1 cat5 cat4 mt-30">
                    <div class="popular-menu__item">
                        <div class="popular-menu__thumb">
                            <img src="{{('frontend/images/menu/menu-5.jpeg')}}" alt="">
                        </div>
                        <div class="popular-menu__content text-center">
                            <h2 class="title">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 grid-item cat6 cat4 mt-30">
                    <div class="popular-menu__item">
                        <div class="popular-menu__thumb">
                            <img src="{{('frontend/images/menu/menu-6.jpeg')}}" alt="">
                        </div>
                        <div class="popular-menu__content text-center">
                            <h2 class="title">
                ...
                <div class="col-md-4 align-self-center">
                    <div class="quickview d-flex align-items-center justify-content-center">
                        <div class="quickview__thumb">
                            <img src="{{('frontend/images/products/pp-1.png')}}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
    ...
    <section class="testimonial__area pt-115 pb-110 position-relative bg_img" data-overlay="dark" data-opacity="5" data-background="images/bg/testimonial-bg-2.jpeg">
        <div class="container">
            <div class="row">
                <div class="col-xl-12 text-center">
                            ...
                            <div class="row g-0 justify-content-center">
                                <div class="col-xl-8">
                                    <span class="quote mb-20">
                                        <img src="{{('frontend/images/icons/t-quote.png')}}" alt="">
                                    </span>
                                    ...
                                    <div class="author-info mt-35">
                                        <div class="thumb mb-25">
                                            <img src="{{('frontend/images/author/tm-author.png')}}" alt="">
                                        </div>
                                        <div class="content">
    ...
    <section class="topgrade__area topgrade__area--2 grey-bg pt-115 pb-115 position-relative">
        <span class="shape shape__1 position-absolute"><img src="{{('frontend/images/shape/top-grade-shape-2-1.png')}}" alt=""></span>
        <span class="shape shape__2 position-absolute"><img src="{{('frontend/images/shape/top-grade-shape-2-2.png')}}" alt=""></span>
        <div class="container">
            <div class="row">
                <div class="col-xl-12 text-center">
            ...
            <div class="row mt-none-30">
                <div class="col-xl-3 col-lg-6 col-md-6 mt-30">
                    <div class="topgrade__item topgrade__item--2 text-center">
                        <div class="thumb">
                            <img src="{{('frontend/images/top-grade/tg-2-1.jpeg')}}" alt="">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mt-85">
                    <div class="topgrade__item topgrade__item--2 text-center">
                        <div class="thumb">
                            <img src="{{('frontend/images/top-grade/tg-2-2.jpeg')}}" alt="">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mt-30">
                    <div class="topgrade__item topgrade__item--2 text-center">
                        <div class="thumb">
                            <img src="{{('frontend/images/top-grade/tg-2-3.jpeg')}}" alt="">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mt-85">
                    <div class="topgrade__item topgrade__item--2 text-center">
                        <div class="thumb">
                            <img src="{{('frontend/images/top-grade/tg-2-4.jpeg')}}" alt="">
    ...
    <div class="blog__area blog__area--2 position-relative pt-115 pb-120">
        <span class="shape shape__1">
            <img src="{{('frontend/images/shape/blog-shape-2-1.png')}}" alt="">
        </span>
        <span class="shape shape__2">
            <img src="{{('frontend/images/shape/blog-shape-2-2.png')}}" alt="">
        </span>
        <div class="container">
            ...
            <div class="row mt-none-30">
                <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                    <article class="blog__item blog__item--2">
                        <div class="thumb position-relative">
                            <div class="img">
                                <img src="{{('frontend/images/blog/blog-2-1.jpeg')}}" alt="">
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                    <article class="blog__item blog__item--2">
                        <div class="thumb position-relative">
                            <div class="img">
                                <img src="{{('frontend/images/blog/blog-2-2.jpeg')}}" alt="">
                            </div>
                        </div>
                        <div class="content content__2">
                            <ul class="blog__meta blog__meta--2 list-unstyled d-flex align-items-center justify-content-start">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                    <article class="blog__item blog__item--2">
                        <div class="thumb position-relative">
                            <div class="img">
                                <img src="{{('frontend/images/blog/blog-2-3.jpeg')}}" alt="">
                            </div>
                        </div>
                        <div class="content content__2">
                            <ul class="blog__meta blog__meta--2 list-unstyled d-flex align-items-center justify-content-start">
...
<script src="{{asset('frontend/js/scrollwatch.js')}}"></script>
