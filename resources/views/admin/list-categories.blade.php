                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{URL::to('/active-category',[$cate_pro->category_id])}}" class="text-dark text-center fw-bolder text-hover-primary d-block fs-6"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="fill: #16A2F9;transform: msFilter;">
                                        ...
                                        @else
                                        <a href="{{URL::to('/unactive-category',[$cate_pro->category_id])}}" class="text-dark text-center fw-bolder text-hover-primary d-block fs-6"><span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="fill: #F91616;transform: msFilter;">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            ...
                                            <a href="{{URL::to('/delete-category',[$cate_pro->category_id])}}" onclick="return confirm('Are you sure delete this category?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
