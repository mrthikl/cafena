        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_new_card_form" method="post" class="form" action="{{URL::to('/add-product')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                <span class="required">Name Product</span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a card holder's name"></i>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Name" name="product_name" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            <!--begin::Label-->
                            <label class="required fs-6 fw-bold form-label mb-2">Description product</label>
                            <!--end::Label-->
                            <!--begin::Input wrapper-->
                            <div class="position-relative">
                                <!--begin::Input-->
                                <textarea type="text" cols="10" rows="5" placeholder="Description" class="form-control form-control-solid" placeholder="" name="product_desc"></textarea>
                                <!--end::Input-->
                            </div>
                            <!--end::Input wrapper-->
                        </div>
                        ...
                        <div class=" mb-10">
                            ...
                            <div class="">
                                ...
                                <div class="">
                                    <!--begin::Col-->
                                    <div class="w-100">
                                        <select name="product_cate" class="form-select form-select-solid">
                        ...
                        <div class=" mb-10">
                            ...
                            <div class="">
                                ...
                                <div class="">
                                    <!--begin::Col-->
                                    <div class="w-100">
                                        <select name="product_status" class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Display">
                                            <option></option>
    ...
    <div class="modal fade" id="kt_modal_update_card" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_new_card_form" method="post" class="form" action="{{URL::to('/update-product')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row">
                            <!--begin::Label-->
                            ...
                            <!--end::Label-->
                            <input id="update-form-name" type="text" class="form-control form-control-solid" placeholder="Name" name="product_name" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <div class="position-relative">
                                <!--begin::Input-->
                                <textarea id="update-form-desc" type="text" cols="10" rows="5" placeholder="Description" class="form-control form-control-solid" placeholder="" name="product_desc"></textarea>
                                <!--end::Input-->
                            </div>
                            <!--end::Input wrapper-->
                        </div>
                        ...
                        <!--begin::Actions-->
                        <div class="text-center pt-15">
                            <input type="hidden" id="update-form-id" name="product_id" value="">
                            <button type="reset" id="kt_modal_new_card_cancel" class="btn btn-light me-3">Discard</button>
