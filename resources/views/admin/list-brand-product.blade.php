                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                            ...
                            <!--end::Table head-->
                            <!--begin::Table body-->
                            @foreach($list_brand_products as $brand_pro)
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    ...
                                    <td>
                                     ...
                                     @if($brand_pro->brand_status == 0)
                                            ...
                                            <a href="{{URL::to('/active-brand-product',[$brand_pro->brand_id])}}" class="text-dark text-center fw-bolder text-hover-primary d-block fs-6"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="fill: #16A2F9;transform: ;msFilter:;">
                                    ...
                                    @else
                                            <a href="{{URL::to('/unactive-brand-product',[$brand_pro->brand_id])}}" class="text-dark text-center fw-bolder text-hover-primary d-block fs-6"><span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="fill: #F91616;transform: ;msFilter:;">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            ...
                                            <a href="{{URL::to('/delete-brand-product',[$brand_pro->brand_id])}}" onclick="return confirm('Are you sure delete this brand?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_new_card_form" method="post" class="form" action="{{URL::to('/add-brand-product')}}">
                        {{csrf_field()}}
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                <span class="required">Name Brand</span>
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a card holder's name"></i>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Name" name="brand_product_name" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row">
                            <!--begin::Label-->
                            <label class="required fs-6 fw-bold form-label mb-2">Description Brand</label>
                            <!--end::Label-->
                            <!--begin::Input wrapper-->
                            <div class="position-relative">
                                <!--begin::Input-->
                                <textarea type="text" cols="10" rows="5" placeholder="Description" class="form-control form-control-solid" placeholder="" name="brand_product_desc"></textarea>
                                <!--end::Input-->
                            </div>
                            <!--end::Input wrapper-->
                        </div>
                        ...
                        <div class=" mb-10">
                            ...
                            <div class="">
                                ...
                                <div class="">
                                    <!--begin::Col-->
                                    <div class="w-100">
                                        <select name="brand_product_status" class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Display">
                                            <option></option>
    ...
    <div class="modal fade" id="kt_modal_update_card" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_new_card_form" method="post" class="form" action="{{URL::to('/update-brand-product')}}">
                        {{csrf_field()}}
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row">
                            <!--begin::Label-->
                            ...
                            <!--end::Label-->
                            <input id="update-form-name" type="text" class="form-control form-control-solid" placeholder="Name" name="brand_product_name" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <div class="position-relative">
                                <!--begin::Input-->
                                <textarea id="update-form-desc" type="text" cols="10" rows="5" placeholder="Description" class="form-control form-control-solid" placeholder="" name="brand_product_desc"></textarea>
                                <!--end::Input-->
                            </div>
                            <!--end::Input wrapper-->
                        </div>
                        ...
                        <!--begin::Actions-->
                        <div class="text-center pt-15">
                            <input type="hidden" id="update-form-id" name="brand_product_id" value="">
                            <button type="reset" id="kt_modal_new_card_cancel" class="btn btn-light me-3">Discard</button>
